# Better Search Engine - Frontend

## Overview
This is the frontend for the Better Search Engine project. The frontend is built using React and Chakra UI and provides a user-friendly interface for different user groups: kids, elders, and researchers. It communicates with the backend server to process search queries and display relevant results.
